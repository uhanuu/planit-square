...
public final class YearRangeHelper {
   ...
   *
   * <p>생성되는 연도 개수는 {@link YearPolicy#RANGE_LENGTH}에 정의된 값을 따릅니다.
   *
   ...
   * @since 1.0
   */
  public static List<Integer> generateYearsFromEnd(int endYear) {
    YearPolicy.requireAtLeastMinYear(endYear);
    int startYear = YearPolicy.calculateStartYear(endYear);
